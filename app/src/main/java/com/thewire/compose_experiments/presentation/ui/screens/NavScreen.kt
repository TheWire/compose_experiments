...
fun NavScreen(
    ...
    ModalDrawer(
        ...
        Column(
            ...
            Button(
                onClick = { navController.navigate("TEST_ROUTE_19") }
            ) {
                Text("To Screen 19")
            }
            Button(
                onClick = { navController.navigate("TEST_ROUTE_20") }
            ) {
                Text("Button + Gesture")
            }
            Button(
                onClick = { navController.navigate("TEST_ROUTE_21") }
            ) {
                Text("drag")
            }
            Button(
            ...
            Button(
                onClick = { navController.navigate("TEST_ROUTE_24") }
            ) {
                Text("Pager")
            }
            Button(
